...
% Generating Remote t'
PhaseNoiseVector = [0 1e-7 1e-15 1e-11 1e-15];
...
% (angle) locations
[x,y,z] = ECS2ECEF( satellite_start_delta + t*satellite_omega, ...
...
ChipCode_b = LFSR_t(t - range_x/c, ChipRate, LFSR_INIT, LFSR_POL);

received_r = received_amp.*sin(w0*t - k0*range_x + ChipCode_b*pi);